...
public interface DoubleMatrix {
     ...
     */
    public operator fun get(x: UInt, y: UInt): Double
     ...
     * @param y The y position.
     */
    public operator fun set(x: UInt, y: UInt, value: Double)
     ...
     */
    public fun getValue(x: UInt, y: UInt): Double = get(x, y)
     ...
     */
    public fun setColumn(x: UInt, vararg values: Double)
     ...
     * @param values The values.
     */
    public fun setRow(y: UInt, vararg values: Double)
     ...
     */
    public fun setValue(x: UInt, y: UInt, value: Double): Unit = set(x, y, value)
