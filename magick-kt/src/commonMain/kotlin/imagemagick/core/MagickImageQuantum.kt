...
interface MagickImageQuantum<TQuantumType> : MagickImage where TQuantumType : Number {
    /**
...
//
    ...
    fun ping(data: ByteArray, offset: UInt, count: UInt, readSettings: IMagickReadSettings<TQuantumType>?)
     ...
     * @throws MagickException Thrown when an error is raised by ImageMagick.
     */
    fun ping(data: ByteArray, readSettings: IMagickReadSettings<TQuantumType>?)
...
//
     ...
     * @throws MagickException Thrown when an error is raised by ImageMagick.
     */
    fun read(data: ByteArray, offset: UInt, count: UInt, readSettings: IMagickReadSettings<TQuantumType>?)
     ...
     */
    @Throws(MagickException::class, IllegalArgumentException::class)
    fun read(data: ByteArray, readSettings: IMagickReadSettings<TQuantumType>?)
...
//     * @throws MagickException Thrown when an error is raised by ImageMagick.
//     */
//    fun readPixels(data: ByteArray, settings: IPixelReadSettings<TQuantumType>)
//
//    /**
...
//     * @throws MagickException Thrown when an error is raised by ImageMagick.
//     */
//    fun readPixels(data: ByteArray, offset: Int, count: Int, settings: IPixelReadSettings<TQuantumType>)
//
//    #if !Q8
//
//    /**
